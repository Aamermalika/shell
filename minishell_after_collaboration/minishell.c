...
/*   Updated: 2022/09/20 17:53:52 by maamer           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int built_in_check(char *line)
{
	...
	if (!ft_strncmp("cd", to_lower(line), max(ft_strlen(line), ft_strlen("cd"))))
		return 11;
	else if (!ft_strncmp("pwd", to_lower(line), max(ft_strlen(line), ft_strlen("pwd"))))
		return 12;
	else if (!ft_strncmp("export", line, max(ft_strlen(line), ft_strlen("export"))))
		return 13;
	else if (!ft_strncmp("unset", to_lower(line), max(ft_strlen(line), ft_strlen("unset"))))
		return 14;
